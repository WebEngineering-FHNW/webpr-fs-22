...
// introduce testcases for eg pair
    const a = Pair(0)(1);
    const b = Pair(2)(3);
    const c = Pair(2)(4); // a+b = c
    snakeOk.push( pairEq(c) (pairPlus(a)(b)) );
//introduce testcases for map pair
//     snakeOk.push( (c) (pairMap( x => x+1) (a)));
//     snakeOk.push( (Pair(1)(2)) (pairMap( x => x+1) (a)));
