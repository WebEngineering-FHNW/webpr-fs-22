...
let snake = [
    Pair(10)(5), // pair is immutable dataType! cannot deconstruct the pair!
    Pair(10)(6),
    Pair(10)(7),
    Pair(10)(8),
];
...
//const pairPlus = a => b =>  Pair()(); // cant change de pair so it needs a new one
const pairPlus = a => b => Pair( a(fst)+ b(fst) ) ( b(snd)+b(snd) ); //
